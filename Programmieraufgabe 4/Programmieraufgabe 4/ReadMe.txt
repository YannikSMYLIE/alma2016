========================================================================
    KONSOLENANWENDUNG: Programmieraufgabe 4-Projektübersicht
========================================================================

Diese Programmieraufgabe 4-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Programmieraufgabe 4-Anwendung besteht.


Programmieraufgabe 4.vcxproj
...
Programmieraufgabe 4.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Programmieraufgabe 4.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
